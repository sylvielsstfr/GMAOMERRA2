...
if __name__ == "__main__":
    ...
    DATAFIELD_NAME =  'TAUTOT'
    DATAFIELD_UNIT = DATAFIELD_NAME+' (units:1) '
    ...
    os.environ["HDFEOS_ZOO_DIR"] = "/sps/lsst/data/AtmosphericCalibration/MERRA-2/May-Jun-2017/subset_M2T1NXRAD_V5.12.4_20180424_203634"

    # If a certain environment variable is set, look there for the input
    # file, otherwise look in the current directory.
    #hdffile = 'MERRA2_400.inst1_2d_asm_Nx.20161001.nc4'
    #hdffile = 'MERRA2_400.inst1_2d_asm_Nx.20170603.nc4'
    hdffile = 'MERRA2_400.tavg1_2d_rad_Nx.20170430.nc4' 
